...
from typing_extensions import List, Generator, Callable

from ..data_models.chat_message import ChatMessage
from ..data_models.chat_response import ChatResponse
...
6. 一致且全面：确保访谈的核心信息均能反映在总结中，避免遗漏关键点。"""
    PROMPT_SYSTEM = """You are 小木, a caring friend and confident. You're here to help with anything you can.
...
- You're a helpful friend and confident that loves to engage in casual conversations. 
